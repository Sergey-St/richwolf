    ...
    methods
        ...
        function obj = calcAmpExFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    ...
                    ampEx(k,kk) = ampEx(k,kk) + integral2(@(theta, phi)underintEx(obj, theta, r, obj.zCross, psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpEyFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    [r, psi] = obj.calcrpsi(obj.rCoord(kk), obj.rCoord(k));
                    ampEy(k,kk) = ampEy(k,kk) + integral2(@(theta, phi)underintEy(obj, theta, r, obj.zCross, psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpEzFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    [r, psi] = obj.calcrpsi(obj.rCoord(kk), obj.rCoord(k));
                    ampEz(k,kk) = ampEz(k,kk) + integral2(@(theta, phi)underintEz(obj, theta, r, obj.zCross, psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHxFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    [r, psi] = obj.calcrpsi(obj.rCoord(kk), obj.rCoord(k));
                    ampHx(k,kk) = ampHx(k,kk) + integral2(@(theta, phi)underintHx(obj, theta, r, obj.zCross, psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHyFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    [r, psi] = obj.calcrpsi(obj.rCoord(kk), obj.rCoord(k));
                    ampHy(k,kk) = ampHy(k,kk) + integral2(@(theta, phi)underintHy(obj, theta, r, obj.zCross, psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHzFocus(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.rNum
                    [r, psi] = obj.calcrpsi(obj.rCoord(kk), obj.rCoord(k));
                    ampHz(k,kk) = ampHz(k,kk) + integral2(@(theta, phi)underintHz(obj, theta, r, obj.zCross, psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpExAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    ...
                    ampEx(k,kk) = ampEx(k,kk) + integral2(@(theta, phi)underintEx(obj, theta, r, obj.zCoord(kk), psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpEyAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    [r, psi] = obj.calcrpsi(0, obj.rCoord(k));
                    ampEy(k,kk) = ampEy(k,kk) + integral2(@(theta, phi)underintEy(obj, theta, r, obj.zCoord(kk), psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpEzAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    [r, psi] = obj.calcrpsi(0, obj.rCoord(k));
                    ampEz(k,kk) = ampEz(k,kk) + integral2(@(theta, phi)underintEz(obj, theta, r, obj.zCoord(kk), psi, phi, cos(phi), sin(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHxAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    [r, psi] = obj.calcrpsi(0, obj.rCoord(k));
                    ampHx(k,kk) = ampHx(k,kk) + integral2(@(theta, phi)underintHx(obj, theta, r, obj.zCoord(kk), psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHyAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    [r, psi] = obj.calcrpsi(0, obj.rCoord(k));
                    ampHy(k,kk) = ampHy(k,kk) + integral2(@(theta, phi)underintHy(obj, theta, r, obj.zCoord(kk), psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
        ...
        function obj = calcAmpHzAlongZ(obj)
            ...
            for k = 1:obj.rNum
                for kk = 1:obj.zNum
                    [r, psi] = obj.calcrpsi(0, obj.rCoord(k));
                    ampHz(k,kk) = ampHz(k,kk) + integral2(@(theta, phi)underintHz(obj, theta, r, obj.zCoord(kk), psi, phi, -1*sin(phi), cos(phi)), 0, obj.thetaMax, 0, 2*pi);
                end
            end
